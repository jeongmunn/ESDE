...
if ($updateDesignFormContainer.length != 0) {
    // // add this to prevent BROKEN AUTHENTICATION
    ...
    $('#submitButton').on('click', function(event) {
        ...
        // obtain fileId from URL to double check
        let URL = window.location.href;
        let URLFileId = URL.substring(URL.lastIndexOf('=') + 1);
        ...
        // added
        webFormData.append('URLFileId', URLFileId);
        axios({
                method: 'put',
    ...
    function getOneData() {
        ...
        axios({
                ...
                method: 'get',
                url: 'https://w3j79gwzo9.execute-api.us-east-1.amazonaws.com/security?fid=' + fileId,
